...
# Flatten the hand landmarks into a single row
flat_hand_landmarks = [data for sublist in frame_hand_landmarks for data in sublist]
...
with mp_hands.Hands(
    ...
    while webcam.isOpened():
        ...
        if results.multi_hand_landmarks:
            ...
            flat_hand_landmarks = [data for sublist in frame_hand_landmarks for data in sublist]
            predicted_hand = model.predict([flat_hand_landmarks])
            player_choice = predicted_hand[0] 
